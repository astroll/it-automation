...
*/
    ...
    $table = new TableControlAgent('B_ANS_LNS_CONTENTS_FILE','CONTENTS_FILE_ID', $g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-1800001"), 'B_ANS_LNS_CONTENTS_FILE_JNL', $tmpAry);
    $tmpAryColumn = $table->getColumns();
    $tmpAryColumn['CONTENTS_FILE_ID']->setSequenceID('B_ANS_LNS_CONTENTS_FILE_RIC');
    $tmpAryColumn['JOURNAL_SEQ_NO']->setSequenceID('B_ANS_LNS_CONTENTS_FILE_JSQ');
    unset($tmpAryColumn);
