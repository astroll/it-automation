...
*/
    ...
    $table = new TableControlAgent('B_ANSIBLE_LNS_TEMPLATE','ANS_TEMPLATE_ID', $g['objMTS']->getSomeMessage("ITAANSIBLEH-MNU-106010"), 'B_ANSIBLE_LNS_TEMPLATE_JNL', $tmpAry);
    $tmpAryColumn = $table->getColumns();
    $tmpAryColumn['ANS_TEMPLATE_ID']->setSequenceID('B_ANSIBLE_LNS_TEMPLATE_RIC');
    $tmpAryColumn['JOURNAL_SEQ_NO']->setSequenceID('B_ANSIBLE_LNS_TEMPLATE_JSQ');
    unset($tmpAryColumn);
