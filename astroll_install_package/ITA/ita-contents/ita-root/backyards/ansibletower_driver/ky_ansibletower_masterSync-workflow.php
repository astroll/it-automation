...
require_once($root_dir_path . "/libs/backyardlibs/ansibletower_driver/restapi_command/AnsibleTowerRestApiInstanceGroups.php");
...
try {
    ...
    $instanceGroupRows = $dbAccess->selectRows("B_ANSTWR_INSTANCE_GROUP", true);
    ...
    $livingIds = array();
    $tableName = "B_ANSTWR_INSTANCE_GROUP";
    // 新規追加 or 更新
    ...
    $livingRows = $dbAccess->selectRows("B_ANSTWR_INSTANCE_GROUP");
    $checker = array();
    $dummy_value = 1;
