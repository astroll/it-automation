...
callback.prototype =
{
	...
	Mix2_1_vars_reg : function( result ){
		...
		if( ary_result[0] == "000" ){
			...
			if( ary_result01[2] == "NORMAL_VAR_1"){
				textPrintToBoxes('2','Mix2_1_10'); // `代入順序'入力欄を活性化させる
			}
			else{
	...
	Mix2_1_key_vars_reg : function( result ){
		...
		if( ary_result[0] == "000" ){
			...
			if( ary_result01[2] == "NORMAL_VAR_1"){
				textPrintToBoxes('2','Mix2_1_7'); // `代入順序'入力欄を活性化させる
			}
			else{
	...
	Mix1_1_val_chlVar_upd : function( result ){
		...
		if( ary_result[0] == "000" ){
			...
			if( ary_result01[2] == "MEMBER_VAR_0" ){
				...
				textPrintToBoxes('2','Mix1_1_10'); // `代入順序'の入力欄を活性化させる
			}
		}
		else{
			window.alert(getSomeMessage("ITAWDCC90101"));
	...
	Mix2_1_val_chlVar_reg : function( result ){
		...
		if( ary_result[0] == "000" ){
			...
			if( ary_result01[2] == "MEMBER_VAR_0" ){
				...
				textPrintToBoxes('2','Mix2_1_10'); // `代入順序'の入力欄を活性化させる
			}
		}
		else{
			window.alert(getSomeMessage("ITAWDCC90101"));
	...
	Mix1_1_key_chlVar_upd : function( result ){
		...
		if( ary_result[0] == "000" ){
			...
			if( ary_result01[2] == "MEMBER_VAR_0" ){
				...
				textPrintToBoxes('2','Mix1_1_7'); // `代入順序'の入力欄を活性化させる
			}
		}
		else{
			window.alert(getSomeMessage("ITAWDCC90101"));
	...
	Mix2_1_key_chlVar_reg : function( result ){
		...
		if( ary_result[0] == "000" ){
			...
			if( ary_result01[2] == "MEMBER_VAR_0" ){
				...
				textPrintToBoxes('2','Mix2_1_7'); // `代入順序'の入力欄を活性化させる
			}
		}
		else{
			window.alert(getSomeMessage("ITAWDCC90101"));
