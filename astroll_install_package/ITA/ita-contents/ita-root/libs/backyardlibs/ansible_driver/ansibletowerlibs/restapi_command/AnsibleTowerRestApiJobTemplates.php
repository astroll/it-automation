...
class AnsibleTowerRestApiJobTemplates extends AnsibleTowerRestApiBase {
    ...
    const IDENTIFIED_NAME_PREFIX = "astroll_%s_executions_jobtpl_%s_%s";
    const PREPARE_BUILD_NAME_PREFIX = "astroll_%s_executions_prepare_build_%s";
    const API_SUB_PATH_LAUNCH  = "launch/";
    const LAUNCH_PLAYBOOK_NAME = "site.yml";
    const CLEANUP_PREPARED_BUILD_NAME_PREFIX = "astroll_%s_executions_cleanup_%s";
    const SEARCH_NAME_PREFIX = "astroll_%s_executions_jobtpl_%s_";
