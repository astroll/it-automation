...
class AnsibleTowerRestApiProjects extends AnsibleTowerRestApiBase {
    ...
    const SCM_LOCALPATH_PREFIX = "astroll_%s_executions_%s";
    const IDENTIFIED_NAME_PREFIX = "astroll_%s_executions_project_%s";

    const PREPARE_BUILD_PROJECT_NAME = "astroll_executions_prepare_build";
    const CLEANUP_PREPARED_BUILD_PROJECT_NAME = "astroll_executions_cleanup";
