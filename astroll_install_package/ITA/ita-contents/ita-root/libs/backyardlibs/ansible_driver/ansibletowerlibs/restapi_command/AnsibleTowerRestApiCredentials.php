...
class AnsibleTowerRestApiCredentials extends AnsibleTowerRestApiBase {
    ...
    //const IDENTIFIED_NAME_PREFIX = "astroll_executions_credential_";
    //const PREPARE_BUILD_CREDENTIAL_NAME = "astroll_executions_local";
    const IDENTIFIED_NAME_PREFIX = "astroll_%s_executions_credential_%s_%s";
    const PREPARE_BUILD_CREDENTIAL_NAME = "astroll_executions_local";
