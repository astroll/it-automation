...
class BAnstwrIfInfo extends TableBaseDefinition {

    public static function getTableName() {
        return "B_ANSTWR_IF_INFO";
    }

    protected static $specificColumns = array(
            "ANSTWR_IF_INFO_ID"             => "",
            "ANSTWR_STORAGE_PATH_ITA"       => "",
            "ANSTWR_STORAGE_PATH_ANSTWR"    => "",
            "SYMPHONY_STORAGE_PATH_ANSTWR"  => "",
            "ANSTWR_PROTOCOL"               => "",
            "ANSTWR_HOSTNAME"               => "",
            "ANSTWR_PORT"                   => "",
            "ANSTWR_USER_ID"                => "",
