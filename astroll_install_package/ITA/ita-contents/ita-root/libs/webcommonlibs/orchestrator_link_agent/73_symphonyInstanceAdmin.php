...
function MovementValidator($tgtSource_row,$intOperationNoUAPK,&$MovementErrorMsg,$intFocusIndex){
    ...
    case 5:   // legacy role
        ...
        break;
    case 6:   // SCRAB
        $ret = SCRABMovementValidator($tgtSource_row,$intOperationNoUAPK,$MovementErrorMsg,$intFocusIndex);
        break;
    case 7:   // OpenAudIT
        $ret = OpenAudITMovementValidator($tgtSource_row,$intOperationNoUAPK,$MovementErrorMsg,$intFocusIndex);
        break;
    case 8:   // DSC
        $ret = DscMovementValidator($tgtSource_row,$intOperationNoUAPK,$MovementErrorMsg,$intFocusIndex);
        break;
    case 12:   // AnsibleTower
        $ret = AnsibleTowerMovementValidator($tgtSource_row,$intOperationNoUAPK,$MovementErrorMsg,$intFocusIndex);
        break;
...
// SCRAB Movementの登録状態を確認
function SCRABMovementValidator($tgtSource_row,$intOperationNoUAPK,&$MovementErrorMsg,$intFocusIndex){
    global $g;
    $objMTS = $g['objMTS'];
    $objDBCA = $g['objDBCA'];
...
// OpenAudIT Movementの登録状態を確認
function OpenAudITMovementValidator($tgtSource_row,$intOperationNoUAPK,&$MovementErrorMsg,$intFocusIndex){
    global $g;
    $objMTS = $g['objMTS'];
    $objDBCA = $g['objDBCA'];
...
// AnsibleTower Movementの登録状態を確認
function AnsibleTowerMovementValidator($tgtSource_row,$intOperationNoUAPK,&$MovementErrorMsg,$intFocusIndex){
    global $g;
    $objMTS = $g['objMTS'];
    $objDBCA = $g['objDBCA'];
