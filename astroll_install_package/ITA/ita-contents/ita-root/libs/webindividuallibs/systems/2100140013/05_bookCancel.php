...
//
    ...
    $strExeJnlTableIdForSelect = 'E_ANSTWR_EXE_INS_MNG_JNL';
    ...
    try{
        ...
        if( $retArray[0] === true ){
            ...
            if( $selectRowLength != 1 ){
                $warning_info = $g['objMTS']->getSomeMessage("ITAANSTWRH-ERR-102030");
        ...
        if( $status_id != 9 ){
            // エラー箇所をメモ
            $warning_info = $g['objMTS']->getSomeMessage("ITAANSTWRH-ERR-102040",$status_name);
        ...
        // 正常向けの結果メッセージを作成
        $output_str = $g['objMTS']->getSomeMessage("ITAANSTWRH-STD-1102050",$target_execution_no);
    }
    catch (Exception $e){
