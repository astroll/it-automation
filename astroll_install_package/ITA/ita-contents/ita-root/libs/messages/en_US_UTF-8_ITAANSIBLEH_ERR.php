...
$ary[55256] = "astroll proprietary variable cannot be used in template file because protocol of device list is blank. (Playbook:{} Template file:{} astroll proprietary variable:{} host:{})";
$ary[55257] = "astroll proprietary variable cannot be used in template file because login user ID of device list is blank. (Playbook:{} Template file:{} astroll proprietary variable:{} host:{})";
$ary[55258] = "astroll proprietary variable cannot be used in template file because login password of device list is blank. (Playbook:{} Template file:{} astroll proprietary variable:{} host:{})";
$ary[55259] = "astroll proprietary variable cannot be used in template file because host name of device list is blank. (Playbook:{} Template file:{} astroll proprietary variable:{} host:{})";
...
$ary[55261] = "astroll proprietary variable cannot be used in template file because protocol of device list is blank. (Playbook:{} Template file:{} astroll proprietary variable:{} host:{})";
$ary[55262] = "astroll proprietary variable cannot be used in template file because login user ID of device list is blank. (Playbook:{} Template file:{} astroll proprietary variable:{} host:{})";
$ary[55263] = "astroll proprietary variable cannot be used in template file because login password of device list is blank. (Playbook:{} Template file:{} astroll proprietary variable:{} host:{})";
$ary[55264] = "astroll proprietary variable cannot be used in template file because host name of device list is blank. (playbook:{} Template file:{} astroll proprietary variable:{} host:{})";
...
$ary[56206] = "astroll proprietary variable cannot be used in dialog file because host name of device list is blank. (Dialog file:{} astroll proprietary variable:{} host:{})";
$ary[56207] = "astroll proprietary variable cannot be used in dialog file because login user ID of device list is blank. (Dialog file:{} astroll proprietary variable:{} host:{})";
$ary[56208] = "astroll proprietary variable cannot be used in dialog file because login password of device list is blank. (Dialog file:{} astroll proprietary variable:{} host:{})";
$ary[56209] = "astroll proprietary variable cannot be used in dialog file because protocol of device list is blank. (Dialog file:{} astroll proprietary variable:{} host:{})";
$ary[56210] = "astroll proprietary variable cannot be used in playbook because host name of device list is blank. (Playbook:{} astroll proprietary variable: host:{})";
$ary[56211] = "astroll proprietary variable cannot be used in playbook because login user ID of device list is blank. (playbook:{} astroll proprietary variable: host:{})";
$ary[56212] = "astroll proprietary variable cannot be used in playbook because login password of device list is blank. (playbook:{} astroll proprietary variable: host:{})";
$ary[56213] = "astroll proprietary variable cannot be used in playbook because protocol of device list is blank. (playbook:{} astroll proprietary variable: host:{})";
...
$ary[70015] = "astroll proprietary variable cannot be used in role because protocol of device list is blank. (role:{} astroll proprietary variable: host:{})";
...
$ary[70020] = "astroll proprietary variable cannot be used in role because protocol of device list is blank. (role:{} astroll proprietary variable: host:{})";
...
$ary[70074] = "Variable not registered in the default variable vars file and astroll Readme is used. (Role package:{} role:{} Variable:{})";
...
$ary[90079] = "default value defining in each Role does not match.";
$ary[90080] = "default value is undefined with some rolls.";
$ary[90081] = "Multiple role package is associated in Movement.";
$ary[90082] = "Movement of Key variable and Val variable is not match.";
...
$ary[102080] = "It is not a status for which schedule can be canceled. (Status:{})";
...
$ary[5000020] = "astroll proprietary variable cannot be used in template file because protocol of device list is blank. (Template file:{} astroll proprietary variable:{} host:{})";
$ary[5000021] = "astroll proprietary variable cannot be used in template file because login user ID of device list is blank. (Template file:{} astroll proprietary variable:{} host:{})";
$ary[5000022] = "astroll proprietary variable cannot be used in template file because login password of device list is blank. (Template file:{} astroll proprietary variable:{} host:{})";
$ary[5000023] = "astroll proprietary variable cannot be used in template file because host name of device list is blank. (Template file:{} astroll proprietary variable:{} host:{})";
...
$ary[5000025] = "astroll proprietary variable cannot be used in template file because protocol of device list is blank. (Template file:{} astroll proprietary variable:{} host:{})";
$ary[5000026] = "astroll proprietary variable cannot be used in template file because login user ID of device list is blank. (Template file:{} astroll proprietary variable:{} host:{})";
$ary[5000027] = "astroll proprietary variable cannot be used in template file because login password of device list is blank. (Template file:{} astroll proprietary variable:{} host:{})";
$ary[5000028] = "astroll proprietary variable cannot be used in template file because host name of device list is blank. (Template file:{} astroll proprietary variable:{} host:{})";
