...
$ary[70016] = "The astroll proprietary variable cannot be used in the role because the login user ID of the device list is blank. (role:{} astroll proprietary variable:{} host:{})";
$ary[70017] = "The astroll proprietary variable cannot be used in the role because the login password of the device list is blank. (role:{} astroll proprietary variable:{} host:{})";
$ary[70018] = "The astroll proprietary variable cannot be used in the role because the host name of the device list has not been entered. (role:{} astroll proprietary variable:{} host:{})";
...
$ary[70021] = "The astroll proprietary variable cannot be used in the role because the login user ID of the device list is blank. (role:{} astroll proprietary variable:{} host:{})";
$ary[70022] = "The astroll proprietary variable cannot be used in the role because the login password of the device list is blank. (role:{} astroll proprietary variable:{} host:{})";
$ary[70023] = "The astroll proprietary variable cannot be used because the host name of the device list is blank. (role:{} astroll proprietary variable:{} host:{})";
...
$ary[70040] = "The authentication method setting of the device list is not valid. (host:{})";
...
$ary[70058] = "Variables used in the role are not registered in the default vars file or the astrollReadme file. (role:{} Variable:{})";
...
$ary[5000005] = "The user variable defined in the translation table is not registered in the default vars file or the astroll readme.";
...
$ary[6040009] = "[Update SCM operation] Failed to get the inventory.";
$ary[6040010] = "[Update SCM operation] No inventory.";
$ary[6040011] = "[Update SCM operation] Failed to get the project.";
$ary[6040012] = "[Update SCM operation] No project.";
$ary[6040013] = "[Update SCM operation] Failed to get the credential information.";
$ary[6040014] = "[Update SCM operation] No credential information.";
$ary[6040015] = "[Update SCM operation] Failed to create job template.";
$ary[6040016] = "[Update SCM operation] Failed to create job template. (Failed to get the ID on creation.)";
$ary[6040017] = "[Update SCM operation] Failed to execute the job.";
$ary[6040018] = "[Update SCM operation] Failed to execute the job. (Failed to get the ID on creation.)";
$ary[6040019] = "[Update SCM operation] Failed to execute the job. (Timeout)";
$ary[6040020] = "[Update SCM operation] Failed to get the job execution progress.";
$ary[6040021] = "[Update SCM operation] Failed to get the job.";
$ary[6040022] = "[Update SCM operation] Failed to get the inventory-hosts.";
