...
$ary[101030] = "管理システム項番";
$ary[101040] = "astroll管理対象システム一覧";
$ary[101050] = "astroll管理対象システム一覧";
$ary[101060] = "HW機器種別";
...
$ary[104621] = "astrollが設定しないインベントリファイルのオプションを設定したい場合に追加するオプションを入力します。\n(例)\n    Pythonのバージョンが2.7以降でhttpsのサーバー証明書の検証を行わない場合。\n  ansible_winrm_server_cert_validation=ignore";
...
$ary[301070] = "astrollロール";
$ary[301080] = "astrollロール";
$ary[302010] = "ADユーザ判定";
$ary[302020] = "項番";
$ary[302030] = "ADユーザ判定";
$ary[302040] = "ADユーザ判定";
$ary[302050] = "ADユーザ識別子";
$ary[302060] = "ADユーザ識別子";
$ary[302070] = "astrollユーザ";
$ary[302080] = "astrollユーザ";
...
$ary[303050] = "astroll側のSymphonyインスタンス毎の共有ディレクトリです。";
...
$ary[900006] = "データエクスポート";
$ary[900007] = "データインポート";
$ary[900008] = "エクスポート/インポート管理";
$ary[900009] = "データインポート処理を受け付けました。<br>実行№：[<strong>{}</strong>]";
$ary[900010] = "下記の機能を提供しています。<br>・インポートデータの閲覧";
$ary[900011] = "下記の機能を提供しています。<br>・インポートデータのアップロード<br>&nbsp;&nbsp;&nbsp;&nbsp;インポートするデータを圧縮したkymファイルをアップロードしてください。<br><br>・データインポート<br>&nbsp;&nbsp;&nbsp;&nbsp;インポート可能なメニューが一覧表示されます。<br>&nbsp;&nbsp;&nbsp;&nbsp;インポートするメニューを選択し、インポートボタンをクリックしてください。<br>&nbsp;&nbsp;&nbsp;&nbsp;インポートするデータの状態はデータインポート管理で確認できます。";
$ary[900012] = "下記の機能を提供しています。<br>&nbsp;&nbsp;・データエクスポート<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;データをエクスポートするメニューを選択し、エクスポートボタンをクリックしてください。";
$ary[900013] = "実行№";
$ary[900014] = "ステータス";
$ary[900015] = "ファイル名";
...
$ary[900024] = "データエクスポート処理を受け付けました。<br>実行№：[<strong>{}</strong>]";
$ary[105075] = "最終実行日時";
$ary[105076] = "オペレーションを実行した実績の日時";
$ary[910001] = "astrollバージョン情報";
$ary[910002] = "ドライバ";
$ary[910003] = "バージョン";
?>